...
class DecanaturaServiceTest {
    ...
    void testCambiarEstado_success() {
        ...
        SolicitudDTO result = decanaturaService.cambiarEstado("1", "aprobar");
    ...
    void testCambiarEstado_notFound() {
        ...
        assertThrows(RuntimeException.class,
                () -> decanaturaService.cambiarEstado("99", "aprobar"));
    }
    ...
    void testObtenerSolicitudesPorFacultad() {
        ...
        List<SolicitudDTO> result = decanaturaService.obtenerSolicitudesPorFacultad(facultadDTO);
    ...
    void testObtenerSolicitudesPorPrioridad() {
        ...
        List<SolicitudDTO> result = decanaturaService.obtenerSolicitudesPorPrioridad(2);
    ...
    void testObtenerSolicitudesPendientes() {
        ...
        List<SolicitudDTO> result = decanaturaService.obtenerSolicitudesPendientes(facultadDTO);
