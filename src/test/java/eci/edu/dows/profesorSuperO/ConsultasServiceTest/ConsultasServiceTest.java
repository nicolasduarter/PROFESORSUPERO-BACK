...
public class ConsultasServiceTest {
    ...
    void consultarCuposGrupo_retornaCuposCuandoGrupoExiste() {
        ...
        int cupos = consultasService.consultarCuposGrupo("grupo1");
    ...
    void consultarCuposGrupo_retornaCeroCuandoGrupoNoExiste() {
        ...
        int cupos = consultasService.consultarCuposGrupo("grupoInexistente");
    ...
    void consultarUltimoHorarioEstudiante_devuelveUltimoHorarioCuandoHayHorarios() {
        ...
        Horario resultado = consultasService.consultarUltimoHorarioEstudiante("est1");
    ...
    void consultarUltimoHorarioEstudiante_retornaNullSiNoHayHorarios() {
        ...
        Horario resultado = consultasService.consultarUltimoHorarioEstudiante("est2");
    ...
    void consultarUltimoHorarioEstudiante_retornaNullSiEstudianteNoExiste() {
        ...
        Horario resultado = consultasService.consultarUltimoHorarioEstudiante("noExiste");
