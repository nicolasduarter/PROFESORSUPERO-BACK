...
public class ClaseServiceTest {
    ...
    void modificarHoraInicio_deberiaActualizarHoraInicio() {
        ...
        ClaseDTO resultado = claseService.modificarHoraInicio("1", nuevoInicio);
    ...
    void modificarHoraInicio_deberiaLanzarExcepcionSiNoExiste() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class,
                () -> claseService.modificarHoraInicio("999", LocalTime.of(9, 0)));
    ...
    void modificarHoraFin_deberiaActualizarHoraFin() {
        ...
        ClaseDTO resultado = claseService.modificarHoraFin("1", nuevoFin);
    ...
    void modificarSalonClase_deberiaActualizarSalon() {
        ...
        ClaseDTO resultado = claseService.modificarSalonClase("1", nuevoSalon);
